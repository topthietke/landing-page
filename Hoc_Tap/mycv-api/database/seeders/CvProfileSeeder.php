...
class CvProfileSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // 1.1 Insert career objective
        $cv_career_objective = [
            [
                'information_id' => 1,
                'title'          => 'Mục tiêu nghề nghiệp',
                'description'    => 'Lập trình viên PHP Laravel với 5 năm kinh nghiệm',
        ...
        DB::table('cv_career_objective')->insert($cv_career_objective);
        // ── 2. EDUCATION ──────────────────────────────────────────────────────
        $educations = [
            [
                'school' => 'Trường Đại học Thái Nguyên',
            ...
            [
                'school' => 'Trường Cao Đăng Sư phạm',
                'major' => 'Công nghệ thông tin',
                'grade' => 'Khá',
                'period' => '09/2006 - 05/2008',
                'sort_order' => 2,
                'created_by' => 1,
                'created_at' => now(),
            ],
            [
                'school' => 'Trường Điện tử Điện lạnh',
                'major' => 'Công nghệ thông tin',
                'grade' => 'Khá',
                'period' => '09/2004 - 05/2006',
                'sort_order' => 3,
                'created_by' => 1,
                'created_at' => now(),
            ],
