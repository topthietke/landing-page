...
<div class="page-title-bar">
    <h1>✏ Chỉnh sửa CV</h1>
    <p>Cập nhật thông tin cá nhân và kinh nghiệm làm việc</p>
</div>
                        ...
                        <div class="col-12">
                            ...
                            <div class="photo-upload-wrap">
                                <div class="photo-preview" id="photoPreview">
                                    <img src="avatar.jpg" alt="Trần Ngọc Tú" width="100%" height="100%"/>
...
<div class="save-bar">
    <button class="btn-save" onclick="saveForm()">
        <svg width="14" height="14" viewBox="0 0 24 24" fill="white" style="margin-right:6px;vertical-align:-2px"><path d="M17 3H5a2 2 0 00-2 2v14a2 2 0 002 2h14a2 2 0 002-2V7l-4-4zm-5 16a3 3 0 110-6 3 3 0 010 6zm3-10H5V5h10v4z"/></svg>
        Lưu thay đổi
    </button>
    ...
    <!-- <button class="btn-preview" onclick="alert('Tính năng xem trước sẽ mở file index.php')">Xem trước CV</button> -->
...
<script>
    ...
    const navLinks = document.querySelectorAll('.cv-sidebar .nav-link');
